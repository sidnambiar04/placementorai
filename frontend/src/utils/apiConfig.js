...
export const API_ENDPOINTS = {
  ...
  MOCK_INTERVIEW_GENERATE: `${API_BASE_URL}/api/v1/interview/generate-questions`, // ← fixed
  MOCK_INTERVIEW_SUBMIT: `${API_BASE_URL}/api/v1/interview/evaluate-answers`,     // ← fixed
