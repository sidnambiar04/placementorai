...
export const API_ENDPOINTS = {
  ...
  INTERVIEW_GENERATE: `${API_BASE_URL}/api/v1/interview/generate-questions`,
  INTERVIEW_SUBMIT: `${API_BASE_URL}/api/v1/interview/evaluate-answers`,
  CAREER_ROADMAP_GENERATE: `${API_BASE_URL}/api/v1/roadmap/generate`,
